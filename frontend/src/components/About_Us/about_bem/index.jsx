...
const AboutBem = () => {
	...
	function handlePointerUp(e) {
		...
		{ img: Img3, title: "Open Recruitment", desc: "Pemuda Pemudi Peduli Lingkungan (P3L)" },
        { img: Img4, title: "Kebersamaan", desc: "Movie Mates Nonton Bareng Artha Darma " },
		{ img: Img5, title: "Kekeluargaan", desc: "BEM Visit Internal Bersama HIMSI" },
		{ img: Img6, title: "Open Recruitment", desc: "Galang Dana Korban Banjir di Mataram" },
		...
		<section ref={ref} className="w-full bg-transparent px-4 sm:px-8 lg:px-16 py-12">
					...
					{/* Left - About text */}
						...
						<p className="text-sm md:text-base text-gray-700 leading-relaxed text-justify font-gotham-book">
							...
							yang visioner, berintegritas, dan berdampak bagi lingkungan sekitar.
						</p>
					</div>
								...
								<div className="md:w-7/12 relative">
									<div
										...
										style={{
											...
											...(desktopWidth ? { width: desktopWidth + 'px', height: '16rem' } : {}),
										}}
									>
							{items.map((it, idx) => (
				<figure
