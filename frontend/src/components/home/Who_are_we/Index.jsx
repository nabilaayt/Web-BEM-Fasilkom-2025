  ...
  return (
    ...
    >
      ...
      <div className="max-w-lg text-center md:text-left">
        ...
        {/* Tombol */}
        <button className="mt-8 bg-[#5A0000] text-white px-6 py-2 rounded-md font-medium hover:bg-[#0000] hover:border hover:border-[#5A0000] hover:text-[#5A0000] transition">
          More About Bem
        </button>
      </div>
    </section>
