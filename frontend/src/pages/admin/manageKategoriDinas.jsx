...
const ManageKategoriDinas = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const message = error.response?.data?.msg || 'Gagal menyimpan kategori dinas';
      toast.error(message);
    }
  };
  ...
  const handleDelete = async (id, nama) => {
    if (window.confirm(`Apakah Anda yakin ingin menghapus kategori dinas "${nama}"?`)) {
      try {
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Kelola Kategori Dinas</h1>
            <p className="text-gray-600">Manage kategori dinas dalam BEM Fasilkom</p>
          </div>
          <button
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  Belum ada bidang. Silakan tambahkan bidang terlebih dahulu di menu <strong>Kelola Bidang</strong>.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-gray-500 mb-4">Belum ada data kategori dinas</p>
              {bidang.length > 0 && (
                <button
                  onClick={() => setShowModal(true)}
                  ...
                  {kategoriDinas.map((item, index) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="font-medium text-gray-900">{item.nama_dinas}</div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        {item.bidang ? (
                          ...
                          <span className="text-gray-400 text-sm">Tidak ada bidang</span>
                        )}
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <button
                            onClick={() => handleDelete(item.id, item.nama_dinas)}
